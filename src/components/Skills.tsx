...
const Skills = () => {
  const skills = [
    ...
    { name: "PostgreSQL", level: 85, color: "from-purple-500 to-pink-500" },
  ];
            ...
            <CardContent className="p-8">
              ...
              <div className="flex flex-wrap gap-3">
                {tools.map((tool, index) => (
                  <span 
                    key={tool}
                    className="px-4 py-2 bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-400/30 rounded-full text-purple-300 text-sm font-medium hover:scale-105 transition-transform duration-200 animate-fade-in"
